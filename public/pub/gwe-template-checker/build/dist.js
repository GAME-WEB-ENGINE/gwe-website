...
class UIMenu extends UIWidget {
  ...
  selectWidget(index, emit = true) {
    ...
    if (!this.multiple) {
      this.widgets.forEach(w => w.unselect());
    }
...
},{"./main_screen":55,"gwe":23}],47:[function(require,module,exports){
...
},{"./enums":48,"./piece":52,"./tile":54}],48:[function(require,module,exports){
let COLOR = {
  BLACK: 'BLACK',
  WHITE: 'WHITE'
};
...
},{"./board":47,"./enums":48,"./piece":52,"./powerup":53,"gwe":23}],50:[function(require,module,exports){
class Command {
...
},{"./enums":48,"./move":51}],53:[function(require,module,exports){
class Powerup {
  constructor(game) {
    this.game = game;
  }
...
},{"./core/enums":48,"./core/game":49,"./core/game_commands":50,"./ui/ui_board":56,"gwe":23}],56:[function(require,module,exports){
let { GWE } = require('gwe');
...
},{"./ui_tile":58,"gwe":23}],57:[function(require,module,exports){
let { GWE } = require('gwe');
...
},{"gwe":23}],58:[function(require,module,exports){
let { GWE } = require('gwe');
let { COLOR } = require('../core/enums');
...
},{"../core/enums":48,"./ui_piece":57,"gwe":23}]},{},[46]);
