...
},{"./main_screen":55,"gwe":29}],54:[function(require,module,exports){
let { GWE } = require('gwe');
...
class MainScreen extends GWE.Screen {
  ...
  handleControllerMoved({ prevPositionX, prevPositionY }) {
    ...
    if (collisionLayer) {
      let leftLocationX = Math.floor((position[0] + this.controller.getColliderLeftOffsetX()) / this.collisionMap.getTileWidth());
      let leftLocationY = Math.floor((position[1] + this.controller.getColliderLeftOffsetY()) / this.collisionMap.getTileHeight());
      let rightLocationX = Math.floor((position[0] + this.controller.getColliderRightOffsetX()) / this.collisionMap.getTileWidth());
      let rightLocationY = Math.floor((position[1] + this.controller.getColliderRightOffsetY()) / this.collisionMap.getTileHeight());
      if (collisionLayer.getTile(leftLocationX, leftLocationY) == 2 || collisionLayer.getTile(rightLocationX, rightLocationY) == 2) {
...
},{"./controller":54,"./selection_rect":56,"gwe":29}],56:[function(require,module,exports){
let { GWE } = require('gwe');
